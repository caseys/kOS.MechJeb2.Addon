 ...
 */
export function parseNumber(output) {
 ...
 */
export function parseTimeString(output) {
 ...
 */
export async function queryNumber(conn, suffix) {
 ...
 */
export async function queryNumberWithRetry(conn, suffix, maxAttempts = 5, retryDelayMs = 200) {
 ...
 */
export async function queryNodeInfo(conn) {
 ...
 */
export async function queryTime(conn, suffix) {
    const result = await conn.execute(`PRINT ${suffix}.`, 2000);
 ...
 */
export async function executeManeuverCommand(conn, cmd, timeout = 10000) {
