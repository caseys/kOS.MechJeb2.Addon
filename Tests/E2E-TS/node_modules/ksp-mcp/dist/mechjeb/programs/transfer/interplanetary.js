 ...
 */
export async function interplanetaryTransfer(conn, waitForPhaseAngle = true) {
    ...
    const cmd = `SET PLANNER TO ADDONS:MJ:CORE:MANEUVERPLANNER. PRINT PLANNER:INTERPLANETARY(${waitForPhaseAngle ? 'TRUE' : 'FALSE'}).`;
