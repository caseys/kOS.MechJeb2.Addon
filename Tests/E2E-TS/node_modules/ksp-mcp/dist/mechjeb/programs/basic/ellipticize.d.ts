 ...
 */
export declare function ellipticize(conn: KosConnection, newPeA: number, newApA: number, timeRef?: string): Promise<ManeuverResult>;
//# sourceMappingURL=ellipticize.d.ts.map