 ...
 */
export function parseLabeled(output) {
    const result = {};
 ...
 */
export function parseLabeledNumber(output, label) {
    const parsed = parseLabeled(output);
 ...
 */
export function parseLabeledBool(output, label) {
    const parsed = parseLabeled(output);
    const value = parsed[label];
 ...
 */
export function parseLabeledNumbers(output, labels) {
    const parsed = parseLabeled(output);
    const result = {};
