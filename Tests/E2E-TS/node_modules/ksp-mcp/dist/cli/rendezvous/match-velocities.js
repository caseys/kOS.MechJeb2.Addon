...
async function main() {
    ...
    try {
        ...
        const relVelResult = await conn.execute('SET RELVEL TO TARGET:VELOCITY:ORBIT - SHIP:VELOCITY:ORBIT. ' +
        ...
        const finalRelVel = await conn.execute('SET RELVEL TO TARGET:VELOCITY:ORBIT - SHIP:VELOCITY:ORBIT. ' +
            'PRINT "Relative velocity: " + ROUND(RELVEL:MAG, 1) + " m/s".');
