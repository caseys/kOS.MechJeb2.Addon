...
import { changeLongitudeOfPeriapsis } from '../../mechjeb/programs/orbital/index.js';
...
async function main() {
    ...
    try {
        ...
        console.log(`3. Creating LONGITUDE node (${timeRef.toLowerCase()})...`);
        const result = await changeLongitudeOfPeriapsis(conn, targetLongDegrees, timeRef);
        if (!result.success) {
