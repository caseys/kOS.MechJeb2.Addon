...
export class KosConnection {
     ...
     */
    async execute(command, timeoutMs = config.timeouts.command) {
     ...
     */
    parseConnectionInfo(output, cpuId) {
